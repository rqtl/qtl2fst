...
```{r cbind_two_subsets}
fapr2 <- probs2fst(subset(apr, chr="2"), "aprx", tmpdir)
fapr3 <- probs2fst(subset(apr, chr="3"), "aprx", tmpdir)
...
```{r create_db_time}
system.time(fpr <- probs2fst(pr, "pr", tmpdir, quiet=TRUE, overwrite=TRUE))
```
